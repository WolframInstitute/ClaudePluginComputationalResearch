...
wiki article via [resource-add](../resource-add/SKILL.md).
...
- **`Wiki/Resources/<Key>.md`** — if the citation deserves a full wiki
  article (will be summarised). Invoke [resource-add](../resource-add/SKILL.md)
...
- [resource-add](../resource-add/SKILL.md) — for full wiki articles instead
  of just BibTeX.
- [math-resources](../math-resources/SKILL.md) — surfaces references from
  MathWorld / Wikipedia that often have DOIs; pipe those DOIs into this skill.
- [paper-init](../paper-init/SKILL.md) — produces the `Paper/references.bib`
