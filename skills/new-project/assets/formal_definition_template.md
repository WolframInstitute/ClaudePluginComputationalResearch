...
If the project uses non-standard notation for this term, fix it here.
...
> **Definition.** Let $X$ be a `Prerequisite`. A *<Term>* on $X$ is a tuple
> $(\\dots)$ such that:
>
> 1. ...
> 2. ...
...
- [[../Theorems/<Theorem>]] — theorems whose statement uses this definition
- External: MathWorld / nLab / Wikipedia / DLMF entries for this term

## Recover

URL: <primary external reference URL for this concept, if any>
