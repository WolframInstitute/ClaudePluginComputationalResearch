Build the paclet's "demo notebook" using the `demo-notebook` skill.
...
Pass the paclet name as argument if ambiguous (e.g., `/demo-notebook SyntheticInfrageometry`). Otherwise detect it from the project's CLAUDE.md or by scanning for PacletInfo.wl.
