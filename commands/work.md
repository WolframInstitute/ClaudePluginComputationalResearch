...
With arguments (e.g. `/work graph curvature solver`), start a new work item: bootstrap Work/ if needed, draft the Spec in `Work/Backlog/`, present it for approval, then break it into session-sized tasks and move it to `Work/Active/`.
